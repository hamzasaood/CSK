...
if(ajaxData.reviews && ajaxData.reviews.length >= userVaribles.options.general.min_reviews){
    var darkButtons = "";
    var reviewsLogo = "img/all-global-assets/logo/reviewsio-logo.svg";
    var
    ...
    htmls +=			'</div></div>';
      if(userVaribles.carousel_type == "topHeader"){
        ...
        htmls+= '<span class="R-ReviewsioLogo__image" src="img/all-global-assets/logo/reviewsio-logo.svg" alt="REVIEWS.io Logo" width="120" height="19"></a></div>';
      }
htmls+=
            '</div>'+
        '</div>';
...
function reviewsio_containsCountry(inputString) {
  const normalizedInput = inputString.toLowerCase();
  return rioCountries.find(country => normalizedInput.includes(country.toLowerCase())) || null;
}
  ...
  for(var i = 0; i< objReview.length; i++){
      try{
        ...
        for(var j = 0; j< address.length; j ++){
          ...
          // if(j == 0){
          //   if(address[j]==""){
          //     tempa = temp_address.split("COUNTRY");
          //     temp_address="COUNTRY"+tempa[1];
          //   }else{
          //     temp_address = temp_address.replace("CITY", address[j]);
          //   }
          // }
          ...
          // else if(j == 1){
          //   if(address[j]==""){
          //     temp_address = temp_address.replace("COUNTRY", "");
          //   }else{
          //     temp_address = temp_address.replace("COUNTRY", address[j]);
          //   }
          // }
